...
public interface WeatherWebServiceSoap {
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportProvinceResponse")
...
;
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetWeatherbyCityNameProResponse")
    ...
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportCityResponse")
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetSupportDataSetResponse")
...
;
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.zhaomsdemo.research.weatherinfo.client.GetWeatherbyCityNameResponse")
